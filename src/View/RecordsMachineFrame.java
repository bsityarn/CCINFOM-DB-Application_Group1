...
public class RecordsMachineFrame extends javax.swing.JFrame {
    ...
    private void refreshTable() {
        DefaultTableModel model = Machine.displayTable();
        jTable1.setModel(model);
    }
    
    private void applyInactiveLock(boolean inactive) {
        editMachineNameField.setEnabled(!inactive);
        editTypeComboBox.setEnabled(!inactive);
        editStatusComboBox.setEnabled(!inactive);
        editConfirmBtn.setEnabled(!inactive);

        if (inactive) {
            resultsLbl.setText("This machine is INACTIVE and cannot be edited.");
        } else {
            resultsLbl.setText("");
        }
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "machineID", "machineName", "deviceType", "status"
            }
        ));
    ...
    private void SearchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchBtnActionPerformed
        ...
        if (machineID.isEmpty()) {
            refreshTable();
            resultsLbl.setText("Search cleared — showing all records.");
            return;
        }
        ...
        try {
            ...
            if (m.getMachineID() == null || m.getMachineID().isBlank()) {
                ...
                jTable1.setModel(new DefaultTableModel(
                        new Object[][]{},
                        new String[]{"Machine ID", "Machine Name", "Device Type", "Status"}
                ));
    ...
    private void deleteMachineBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteMachineBtnActionPerformed
        ...
        int confirm = JOptionPane.showConfirmDialog(this,
                "Are you sure you want to delete (set Inactive) machine " + machineID + "?",
    ...
    private void editEnterBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editEnterBtnActionPerformed
        ...
        try {
            ...
            if ("Inactive".equalsIgnoreCase(m.getStatus())) {
                applyInactiveLock(true);
            } else {
                applyInactiveLock(false);
            }
